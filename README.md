...
For question:
If you want the maders to be unblurred, ask these questions:
1. What is the social security system, What does social security system do?
2. If someone hacked and access all of your files via storage, and can't access to your account, Do you believe scripting can remove hackers?
3. For social, if someone has managed to spam all of the things, what you like to do?
